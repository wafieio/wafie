...
echo "alias gateway=\"cd ${SRC_ROOT} && dlv debug --headless --listen=:2345 --api-version=2 --accept-multiclient gateway/cmd/main.go -- start --api-addr=http://wafie-api \"" >> /tmp/a
...
echo "alias xproc=\"cd ${SRC_ROOT} && dlv debug --headless --listen=:2345 --api-version=2 --accept-multiclient xproc/cmd/main.go -- start --api-addr=http://wafie-api \"" >> /tmp/a
